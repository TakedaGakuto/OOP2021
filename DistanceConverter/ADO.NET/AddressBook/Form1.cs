...
namespace AddressBook
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: このコード行はデータを 'infosys202108DataSet.Person' テーブルに読み込みます。必要に応じて移動、または削除をしてください。
            this.personTableAdapter.Fill(this.infosys202108DataSet.Person);
        }

        private void btNameSearch_Click(object sender, EventArgs e)
        {
            this.personTableAdapter.FillByName(this.infosys202108DataSet.Person,tbNameSearch.Text);
        }
        ...
        {
            this.personTableAdapter.FillByBIrthday(this.infosys202108DataSet.Person,dtpBirthday.Text);
        }
    }
}